...
with col1:
    ...
    st.markdown(
        ...
        <div style="text-align: center; margin-top: 20px;">
            <a href="http://localhost:8502/barriera_da_vivere" class="red-button" style="display: inline-block; padding: 20px 20px; text-decoration: none; color: white;">Barriera da Vivere</a>
        </div>
        """,
        unsafe_allow_html=True,
    )
...
with col2:    
    ...
    st.markdown(
        """
        <div style="text-align: center; margin-top: 20px;">
            <a href="http://localhost:8502/barriera_da_migliroare" class="red-button" style="display: inline-block; padding: 20px 20px; text-decoration: none; color: white;">Barriera da Migliorare</a>
        </div>
        """,
        unsafe_allow_html=True,
    )
